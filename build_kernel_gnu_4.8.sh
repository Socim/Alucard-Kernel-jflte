...
export INITRAMFS_SOURCE=`readlink -f ..`/alucard/Ramdisk
export PACKAGEDIR=$KERNELDIR/READY-JB
#Enable FIPS mode
export USE_SEC_FIPS_MODE=true
export ARCH=arm
export CROSS_COMPILE=/Volumes/android/cm-11.0/prebuilt/linux-x86/toolchain/arm-cortex_a15-linux-gnueabihf-linaro_4.8.3-2014.02/bin/arm-gnueabi-
